...
namespace Photon.Pun
{
    ...
    public class PhotonRigidbodyView : MonoBehaviourPun, IPunObservable
    {
        ...
        public void FixedUpdate()
        {
            ...
            {
                this.m_Body.MovePosition(Vector3.MoveTowards(this.m_Body.position, this.m_NetworkPosition, this.m_Distance * (1.0f / PhotonNetwork.SerializationRate)));
                this.m_Body.MoveRotation(Quaternion.RotateTowards(this.m_Body.rotation, this.m_NetworkRotation, this.m_Angle * (1.0f / PhotonNetwork.SerializationRate)));
            }
        }
